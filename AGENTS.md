...
- Phase 4 — Actor/Party and progressive Profile: active on `feat/phase-04-actor-profile`; 4A owner-local accepted, 4B semantic Profile + recurring Need/Offer declarations implemented remotely and awaiting owner-local/browser acceptance. Profile recurrence records cadence only: do not pull Planner Occurrences (Phase 11), full matching (Phase 13), obligations (Phase 14), generic Context, or Admission v2 forward.
