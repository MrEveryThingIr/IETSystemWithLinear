...
class Agreements extends Component
{
    ...
    public function revise(int $agreementId, ManageGroupAgreement $manager): void
    {
        ...
        $manager->revise($agreement, $this->actor(), $data['content'], $data['rationale'], $data['reacceptanceRequired']);
    ...
    {
        return view('livewire.groups.agreements', ['agreements' => GroupAgreement::query()->where('group_id', $this->group->id)->with('versions')->get()]);
    }
