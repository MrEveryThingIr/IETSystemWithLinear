...
class AccessInvitation extends Model
{
    ...
    protected static function booted(): void
    {
        ...
        static::deleting(function (): never {
            throw new LogicException('Access invitation history is preserved.');
        });
    }
    ...
    public function maskedEmail(): ?string
    {
        ...
        return Str::substr($local, 0, 1)
            .str_repeat('•', max(3, Str::length($local) - 1))
            .'@'.$domain;
    }
    ...
    {
        return $this->hasMany(AccessInvitationAcceptance::class);
    }
