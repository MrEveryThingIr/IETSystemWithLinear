    ...
    public function all(): array
    {
        ...
        return [
            ...
            $this->preset(
                'guide-documentation',
                'Guide / Documentation',
                'A structured educational guide that explains current behavior, ideal target behavior, permissions, usage, misunderstandings, and feedback paths.',
                'learning',
                [
                    $this->field('summary', 'What this page is about', 'long_text', true),
                    $this->field('current_behavior', 'Current implemented behavior', 'long_text', true),
                    $this->field('how_to_use', 'How to use it efficiently', 'long_text', true),
                    $this->field('authorization', 'Who can do what', 'long_text', true),
                    $this->field('ideal_target', 'Ideal target behavior', 'long_text', true),
                    $this->field('misunderstandings', 'Common misunderstandings and boundaries', 'long_text', false),
                ],
                [
                    $this->fieldBlock('summary'),
                    $this->fieldBlock('current_behavior'),
                    $this->fieldBlock('how_to_use'),
                    $this->fieldBlock('authorization'),
                    $this->fieldBlock('ideal_target'),
                    $this->fieldBlock('misunderstandings'),
                ],
                'lesson',
                $allContexts,
                $advanced,
