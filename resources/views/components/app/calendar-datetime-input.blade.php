...
<div class="space-y-2">
    ...
    >
        <input type="hidden" wire:model="{{ $model }}" data-datetime-value>
        ...
        >
            ...
            <div
                ...
                role="dialog"
                aria-label="{{ $label }}"
                class="absolute start-0 z-50 mt-2 w-[min(22rem,calc(100vw-2rem))] max-w-[calc(100vw-2rem)] rounded-2xl border border-zinc-200 bg-white p-4 shadow-xl dark:border-zinc-700 dark:bg-zinc-900"
            >
        ...
        <input
            type="time"
            data-datetime-time
            class="rounded-lg border border-zinc-300 bg-white px-3 py-2 text-sm shadow-sm focus:border-zinc-500 focus:outline-none focus:ring-2 focus:ring-zinc-200 dark:border-zinc-700 dark:bg-zinc-900 dark:focus:ring-zinc-800"
            aria-label="{{ $label }}"
        >
    </iet-datetime-picker>
